...
(class_attendance_id,schedule_id,member_id,attendance_status) VALUES
(1,1,5,'Registered'),
(2,1,3,'Attended'),
(3,7,3,'Registered'),
(4,3,5,'Registered'),
...
(schedule_id,class_id,staff_id,start_time,end_time) VALUES
...
INSERT INTO classes
(class_id,name,description,capacity,duration,location_id) VALUES
...
(log_id,equipment_id,maintenance_date,description,staff_id) VALUES
(1,1,'2024-12-15','Belt replacement',1),
(2,2,'2024-07-20','Oiling and sensor check',1),
(3,3,'2024-03-10','Safety bar adjustment',1);

INSERT INTO equipment
(equipment_id,name,type,purchase_date,last_maintenance_date,next_maintenance_date,location_id) VALUES
...
(location_id,name,address,phone_number,email,opening_hours) VALUES
(1,'Downtown Fitness','123 Main St, London','0205551234','downtown@fittrackpro.com','06:00-22:00'),
(2,'Suburban Wellness','45 Oak Ln, Manchester','01615555678','suburban@fittrackpro.com','05:00-23:00');

INSERT INTO member_health_metrics
(metric_id,member_id,measurement_date,weight,body_fat_percentage,muscle_mass,bmi) VALUES
(1,5,'2025-01-10',65.0,22.5,48.0,24.1),
(2,3,'2025-01-15',80.0,18.0,60.0,25.5);

INSERT INTO members
(member_id,first_name,last_name,email,phone_number,date_of_birth,join_date,emergency_contact_name,emergency_contact_phone) VALUES
...
(membership_id,member_id,type,start_date,end_date,status) VALUES
...
(payment_id,member_id,amount,payment_date,payment_method,payment_type) VALUES
...
(session_id,member_id,staff_id,session_date,start_time,end_time,notes) VALUES
...
INSERT INTO staff
(staff_id,first_name,last_name,email,phone_number,position,hire_date,location_id) VALUES
(1,'James','Bond','james.bond@fittrackpro.com','07007007007','Manager','2022-01-01',1),
(2,'Ivy','Irwin','ivy.irwin@fittrackpro.com','07123456789','Trainer','2023-05-15',1),
(3,'Sarah','Connor','sarah.connor@fittrackpro.com','07999888777','Receptionist','2023-08-01',1),
(4,'Lara','Croft','lara.croft@fittrackpro.com','07555444333','Trainer','2023-09-10',2);